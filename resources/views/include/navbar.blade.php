    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light navbar-default bootsnav">
        <div class="container">
            ...
            <div class="navbar-header" style="width: 40%;">
                ...
                <a class="navbar-brand" href="index.html"><img width="25%" style="margin: 0;" src="images2/SusUntitled.png" class="logo" alt=""></a>
            </div>
            ...
            <li class="cart-box">
                <ul class="cart-list">
                    ...
                    <li>
                        ...
                        <h6><a href="#">Шоколад</a></h6>
                        <p>1x - <span class="price">$40.00</span></p>
                    </li>
                    <li class="total">
                        <a href="cart.html" class="btn btn-default hvr-hover btn-cart">Заказать</a>
                        <span class="float-right"><strong>Всего</strong>: $180.00</span>
                    </li>
                </ul>
            </li>
        </div>
